...
export const loads: Load[] = [
  { id: 'LD-1001', source: 'Mumbai, MH', destination: 'Delhi, DL', pickupDate: '2026-04-10', vehicleType: 'Container 20ft', weight: 8500, budget: 45000, status: 'active', bidsCount: 5, postedDate: '2026-04-08', distance: '1,420 km', handling: 'Fragile — handle with care' },
  { id: 'LD-1002', source: 'Chennai, TN', destination: 'Bangalore, KA', pickupDate: '2026-04-11', vehicleType: 'Open Truck', weight: 3200, budget: 15000, status: 'active', bidsCount: 3, postedDate: '2026-04-09', distance: '350 km' },
  { id: 'LD-1003', source: 'Kolkata, WB', destination: 'Guwahati, AS', pickupDate: '2026-04-09', vehicleType: 'Closed Body', weight: 5000, budget: 28000, status: 'in_transit', bidsCount: 7, postedDate: '2026-04-07', assignedDriver: 'Suresh Kumar', assignedByName: 'Load Dispatcher', assignedById: 'USR-003', distance: '985 km' },
  { id: 'LD-1004', source: 'Hyderabad, TS', destination: 'Pune, MH', pickupDate: '2026-04-12', vehicleType: 'Trailer', weight: 15000, budget: 65000, status: 'active', bidsCount: 2, postedDate: '2026-04-09', distance: '560 km' },
  ...
  { id: 'LD-1007', source: 'Surat, GJ', destination: 'Nagpur, MH', pickupDate: '2026-04-11', vehicleType: 'Closed Body', weight: 6000, budget: 35000, status: 'in_transit', bidsCount: 8, postedDate: '2026-04-06', assignedDriver: 'Amar Singh', assignedByName: 'Priya Sharma', assignedById: 'USR-005', distance: '790 km' },
  { id: 'LD-1008', source: 'Coimbatore, TN', destination: 'Kochi, KL', pickupDate: '2026-04-14', vehicleType: 'Refrigerated', weight: 2800, budget: 18000, status: 'active', bidsCount: 1, postedDate: '2026-04-09', distance: '190 km', handling: 'Temperature controlled (cold chain)' },
  ...
  { id: 'LD-1013', source: 'Visakhapatnam, AP', destination: 'Vijayawada, AP', pickupDate: '2026-04-13', vehicleType: 'Container 20ft', weight: 5500, budget: 20000, status: 'active', bidsCount: 3, postedDate: '2026-04-09', distance: '350 km' },
  ...
  { id: 'LD-1016', source: 'Mysore, KA', destination: 'Chennai, TN', pickupDate: '2026-04-15', vehicleType: 'Refrigerated', weight: 3000, budget: 22000, status: 'active', bidsCount: 2, postedDate: '2026-04-09', distance: '480 km' },
  ...
  { id: 'LD-1020', source: 'Bhubaneswar, OD', destination: 'Visakhapatnam, AP', pickupDate: '2026-04-14', vehicleType: 'Trailer', weight: 16000, budget: 42000, status: 'active', bidsCount: 1, postedDate: '2026-04-09', distance: '440 km' },
];

// ─── Drivers ─────────────────────────────────────────────────────────────────

export const drivers: Driver[] = [
  { id: 'DR-001', name: 'Suresh Kumar', phone: '+91 98765 43210', email: 'suresh.k@email.com', vehicleType: 'Container 20ft', vehicleNumber: 'MH-04-AB-1234', licenseNumber: 'DL-2020-0045', totalTrips: 342, status: 'approved', documentsStatus: { license: 'verified', insurance: 'verified', registration: 'verified', aadhar: 'verified' }, joinedDate: '2024-03-15' },
  { id: 'DR-002', name: 'Rajesh Patel', phone: '+91 87654 32109', email: 'rajesh.p@email.com', vehicleType: 'Container 40ft', vehicleNumber: 'GJ-01-CD-5678', licenseNumber: 'DL-2019-0112', totalTrips: 278, status: 'approved', documentsStatus: { license: 'verified', insurance: 'verified', registration: 'verified', aadhar: 'verified' }, joinedDate: '2024-01-10' },
  { id: 'DR-003', name: 'Amar Singh', phone: '+91 76543 21098', email: 'amar.s@email.com', vehicleType: 'Closed Body', vehicleNumber: 'RJ-14-EF-9012', licenseNumber: 'DL-2021-0078', totalTrips: 415, status: 'approved', documentsStatus: { license: 'verified', insurance: 'verified', registration: 'verified', aadhar: 'verified' }, joinedDate: '2023-11-20' },
  { id: 'DR-004', name: 'Vikram Yadav', phone: '+91 65432 10987', email: 'vikram.y@email.com', vehicleType: 'Open Truck', vehicleNumber: 'UP-32-GH-3456', licenseNumber: 'DL-2022-0034', totalTrips: 156, status: 'approved', documentsStatus: { license: 'verified', insurance: 'pending', registration: 'verified', aadhar: 'verified' }, joinedDate: '2024-06-05' },
  { id: 'DR-005', name: 'Ravi Shankar', phone: '+91 54321 09876', email: 'ravi.s@email.com', vehicleType: 'Container 20ft', vehicleNumber: 'KA-01-IJ-7890', licenseNumber: 'DL-2020-0089', totalTrips: 210, status: 'approved', documentsStatus: { license: 'verified', insurance: 'verified', registration: 'verified', aadhar: 'verified' }, joinedDate: '2024-04-18' },
  { id: 'DR-006', name: 'Mohammed Ali', phone: '+91 43210 98765', email: 'mohammed.a@email.com', vehicleType: 'Container 40ft', vehicleNumber: 'TN-09-KL-2345', licenseNumber: 'DL-2018-0156', totalTrips: 520, status: 'approved', documentsStatus: { license: 'verified', insurance: 'verified', registration: 'verified', aadhar: 'verified' }, joinedDate: '2023-08-12' },
  { id: 'DR-007', name: 'Deepak Nair', phone: '+91 32109 87654', email: 'deepak.n@email.com', vehicleType: 'Closed Body', vehicleNumber: 'KL-07-MN-6789', licenseNumber: 'DL-2021-0201', totalTrips: 187, status: 'approved', documentsStatus: { license: 'verified', insurance: 'verified', registration: 'pending', aadhar: 'verified' }, joinedDate: '2024-02-28' },
  { id: 'DR-008', name: 'Harpreet Singh', phone: '+91 21098 76543', email: 'harpreet.s@email.com', vehicleType: 'Open Truck', vehicleNumber: 'PB-10-OP-0123', licenseNumber: 'DL-2019-0098', totalTrips: 298, status: 'approved', documentsStatus: { license: 'verified', insurance: 'verified', registration: 'verified', aadhar: 'verified' }, joinedDate: '2024-05-10' },
  { id: 'DR-009', name: 'Pradeep Reddy', phone: '+91 10987 65432', email: 'pradeep.r@email.com', vehicleType: 'Trailer', vehicleNumber: 'AP-31-QR-4567', licenseNumber: 'DL-2023-0012', totalTrips: 45, status: 'pending_approval', documentsStatus: { license: 'verified', insurance: 'pending', registration: 'verified', aadhar: 'verified' }, joinedDate: '2026-04-01' },
  { id: 'DR-010', name: 'Arvind Sharma', phone: '+91 09876 54321', email: 'arvind.s@email.com', vehicleType: 'Refrigerated', vehicleNumber: 'MP-09-ST-8901', licenseNumber: 'DL-2023-0045', totalTrips: 32, status: 'pending_approval', documentsStatus: { license: 'verified', insurance: 'missing', registration: 'pending', aadhar: 'verified' }, joinedDate: '2026-03-28' },
  { id: 'DR-011', name: 'Karthik Iyer', phone: '+91 98712 34567', email: 'karthik.i@email.com', vehicleType: 'Container 20ft', vehicleNumber: 'TN-01-UV-2345', licenseNumber: 'DL-2023-0067', totalTrips: 0, status: 'pending_approval', documentsStatus: { license: 'pending', insurance: 'missing', registration: 'missing', aadhar: 'verified' }, joinedDate: '2026-04-05' },
  { id: 'DR-012', name: 'Sanjay Gupta', phone: '+91 87612 34567', email: 'sanjay.g@email.com', vehicleType: 'Open Truck', vehicleNumber: 'DL-01-WX-6789', licenseNumber: 'DL-2022-0189', totalTrips: 78, status: 'rejected', documentsStatus: { license: 'rejected', insurance: 'rejected', registration: 'verified', aadhar: 'verified' }, joinedDate: '2025-12-15' },
  { id: 'DR-013', name: 'Anand Verma', phone: '+91 76512 34567', email: 'anand.v@email.com', vehicleType: 'Closed Body', vehicleNumber: 'UP-80-YZ-0123', licenseNumber: 'DL-2023-0089', totalTrips: 22, status: 'pending_approval', documentsStatus: { license: 'verified', insurance: 'verified', registration: 'pending', aadhar: 'pending' }, joinedDate: '2026-04-07' },
  { id: 'DR-014', name: 'Ramesh Babu', phone: '+91 65412 34567', email: 'ramesh.b@email.com', vehicleType: 'Trailer', vehicleNumber: 'KA-05-AB-4567', licenseNumber: 'DL-2020-0234', totalTrips: 310, status: 'suspended', documentsStatus: { license: 'verified', insurance: 'verified', registration: 'verified', aadhar: 'verified' }, joinedDate: '2023-09-20' },
  { id: 'DR-015', name: 'Prakash Joshi', phone: '+91 54312 34567', email: 'prakash.j@email.com', vehicleType: 'Container 20ft', vehicleNumber: 'MH-12-CD-8901', licenseNumber: 'DL-2023-0101', totalTrips: 0, status: 'pending_approval', documentsStatus: { license: 'verified', insurance: 'pending', registration: 'verified', aadhar: 'missing' }, joinedDate: '2026-04-09' },
];

// ─── Bids ────────────────────────────────────────────────────────────────────

export const bids: Bid[] = [
  { id: 'BD-001', loadId: 'LD-1001', driverId: 'DR-001', driverName: 'Suresh Kumar', vehicleType: 'Container 20ft', vehicleNumber: 'MH-04-AB-1234', price: 42000, eta: '18 hrs', distance: '1,420 km', status: 'pending', submittedAt: '2026-04-08 14:30', totalTrips: 342 },
  { id: 'BD-002', loadId: 'LD-1001', driverId: 'DR-005', driverName: 'Ravi Shankar', vehicleType: 'Container 20ft', vehicleNumber: 'KA-01-IJ-7890', price: 44500, eta: '20 hrs', distance: '1,450 km', status: 'pending', submittedAt: '2026-04-08 15:15', totalTrips: 210 },
  { id: 'BD-003', loadId: 'LD-1001', driverId: 'DR-006', driverName: 'Mohammed Ali', vehicleType: 'Container 40ft', vehicleNumber: 'TN-09-KL-2345', price: 40000, eta: '17 hrs', distance: '1,400 km', status: 'pending', submittedAt: '2026-04-08 16:00', totalTrips: 520 },
  { id: 'BD-004', loadId: 'LD-1001', driverId: 'DR-003', driverName: 'Amar Singh', vehicleType: 'Closed Body', vehicleNumber: 'RJ-14-EF-9012', price: 46000, eta: '19 hrs', distance: '1,430 km', status: 'pending', submittedAt: '2026-04-08 17:45', totalTrips: 415 },
  { id: 'BD-005', loadId: 'LD-1001', driverId: 'DR-008', driverName: 'Harpreet Singh', vehicleType: 'Open Truck', vehicleNumber: 'PB-10-OP-0123', price: 38000, eta: '22 hrs', distance: '1,480 km', status: 'pending', submittedAt: '2026-04-09 08:20', totalTrips: 298 },
  { id: 'BD-006', loadId: 'LD-1002', driverId: 'DR-005', driverName: 'Ravi Shankar', vehicleType: 'Container 20ft', vehicleNumber: 'KA-01-IJ-7890', price: 14000, eta: '5 hrs', distance: '350 km', status: 'pending', submittedAt: '2026-04-09 09:00', totalTrips: 210 },
  { id: 'BD-007', loadId: 'LD-1002', driverId: 'DR-007', driverName: 'Deepak Nair', vehicleType: 'Closed Body', vehicleNumber: 'KL-07-MN-6789', price: 13500, eta: '5.5 hrs', distance: '360 km', status: 'pending', submittedAt: '2026-04-09 10:30', totalTrips: 187 },
  { id: 'BD-008', loadId: 'LD-1002', driverId: 'DR-004', driverName: 'Vikram Yadav', vehicleType: 'Open Truck', vehicleNumber: 'UP-32-GH-3456', price: 15500, eta: '6 hrs', distance: '370 km', status: 'pending', submittedAt: '2026-04-09 11:15', totalTrips: 156 },
  { id: 'BD-009', loadId: 'LD-1004', driverId: 'DR-002', driverName: 'Rajesh Patel', vehicleType: 'Container 40ft', vehicleNumber: 'GJ-01-CD-5678', price: 62000, eta: '8 hrs', distance: '560 km', status: 'pending', submittedAt: '2026-04-09 12:00', totalTrips: 278 },
  { id: 'BD-010', loadId: 'LD-1004', driverId: 'DR-006', driverName: 'Mohammed Ali', vehicleType: 'Container 40ft', vehicleNumber: 'TN-09-KL-2345', price: 58000, eta: '9 hrs', distance: '580 km', status: 'pending', submittedAt: '2026-04-09 13:30', totalTrips: 520 },
];
